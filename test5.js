...
const contractAddress = "0x1402e8ff15694ae96d12e120db1c708189046ef0"; // user
const libraryAddress = '0x373138d5d5f3e52be984587c514a77f9fd5ef071'; // user
...
async function compileAndVerify() {
    ...
    try {
        ...
        const bytecodeWithLibsNParams = bytecodeWithParams.replace(placeholderPattern, cleanLibraryAddress);
        console.log("Compiled Bytecode with Library: ", bytecodeWithLibsNParams);
